...
let haenniro_tests =
  [
    [prefix ^ "/haenniro/stacktest_asm.s"; prefix ^ "/haenniro/stacktest.c"], prefix ^ "/haenniro/stacktest_ll.ll", [], 0L
  ; [prefix ^ "/haenniro/arg_loc_test.c"], prefix ^ "/haenniro/arg_loc_test.ll", [], 1L
  ]
...
let provided_tests : suite = [
    ...
    GradedTest("haenniro test", 0, 
    executed_c_link haenniro_tests)
  ]
